...
\begin{document}
    \begin{tikzpicture}
        ...
        \draw[whiteroad] (-2, 0) -- (-7, 0) -- (-7, 5);
        \draw[whiteroad] (-7, 7) -- (-7, 11);
        \draw[whiteroad] (-7, 13) -- (-7, 17);
        \draw[whiteroad] (-7, 19) -- (-7, 21);
        \draw[whiteroad] (-7, 23) -- (-7, 25);
        \draw[whiteroad] (-7, 27) -- (-7, 34) -- (-5, 34) -- (-5, 41);
        \draw[blackroad] (-5, 41) -- (-5, 42) -- (0, 42);
        \draw[blackroad] (2, 42) -- (4, 42);
        \draw[blackroad] (8, 42) -- (10, 42);
        \draw[whiteroad] (16, 42) -- (17, 42) -- (17, 38) -- (16, 38);
        \draw[whiteroad] (14, 38) -- (12, 38);
        \draw[blackroad] (12, 38) -- (11, 38) -- (11, 37);
        \draw[whiteroad] (11, 37) -- (11, 35);
        \draw[whiteroad] (11, 33) -- (11, 30);
        \draw[whiteroad] (-7, 30) -- (8, 30);
        \draw[whiteroad] (10, 30) -- (12, 30);
    \end{tikzpicture}
\end{document}