...
\begin{document}
    \begin{tikzpicture}
        ...
        airport-square/.style={minimum size=4cm,text width=4cm,font=\huge\bfseries},
        ...
        \node[blue-square] (node-80) at (35, 36) {\ifimportant 80 \fi};
        \node[blue-square] (node-81) at (35, 34) {\ifimportant 81 \fi};
        \node[blue-square] (node-83) at (35, 30) {\ifimportant 83 \fi};
        \node[blue-square] (node-84) at (35, 28) {\ifimportant 84 \fi};
        \node[blue-square] (node-86) at (35, 24) {\ifimportant 86 \fi};
        \node[blue-square] (node-87) at (33, 24) {\ifimportant 87 \fi};
        \node[blue-square] (node-89) at (29, 24) {\ifimportant 89 \fi};
        \node[blue-square] (node-91) at (25, 24) {\ifimportant 91 \fi};
        \node[blue-square] (node-92) at (23, 24) {\ifimportant 92 \fi};
        \node[blue-square] (node-93) at (21, 24) {\ifimportant 93 \fi};
        \node[blue-square] (node-95) at (17, 24) {\ifimportant 95 \fi};
        \node[blue-square] (node-96) at (15, 24) {\ifimportant 96 \fi};
        \node[blue-square] (node-98) at (11, 24) {\ifimportant 98 \fi};
        \node[blue-square] (node-99) at (9, 24) {\ifimportant 99 \fi};
        \node[blue-square] (node-101) at (5, 24) {\ifimportant 101 \fi};
        \node[blue-square] (node-103) at (1, 24) {\ifimportant 103 \fi};
        \node[blue-square] (node-104) at (-1, 24) {\ifimportant 104 \fi};
        \node[blue-square] (node-106) at (-1, 20) {\ifimportant 106 \fi};
        \node[blue-square] (node-108) at (-1, 16) {\ifimportant 108 \fi};
        \node[blue-square] (node-110) at (-1, 12) {\ifimportant 110 \fi};
        \node[blue-square] (node-112) at (-1, 8) {\ifimportant 112 \fi};
        \node[blue-square] (node-114) at (3, 8) {\ifimportant 114 \fi};
        \node[airport-square] (node-115) at (3, 11) {AIRPORT};
