...
\begin{document}
    \begin{tikzpicture}
        [every node/.style={rectangle,draw=black,thick,inner sep=0pt,text width=20mm,align=center},
        home-square/.style={minimum height=2cm,minimum width=4cm,font=\huge},
        blue-square/.style={fill=blue,minimum size=2cm},
        yellow-square/.style={fill=yellow,minimum size=2cm},
        white-square/.style={fill=gray!25,minimum size=2cm,font=\small},
        arrowtip/.tip = {Stealth[scale=2]}
        ]
        ...
        \draw [-arrowtip,rounded corners=1cm,thick] (node-40.north west) -| (node-41.north west);
